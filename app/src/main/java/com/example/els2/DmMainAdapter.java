...
public class DmMainAdapter extends RecyclerView.Adapter<DmMainAdapter.ViewHolder> {
    Activity activity;
    ArrayList<ContactModel> arrayList;
    private OnContactListener onContactListener;


    public DmMainAdapter(Activity activity, ArrayList<ContactModel> arrayList, OnContactListener onContactListener){
    ...
    @NonNull
    @Override
    public DmMainAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //Intialize view
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.dm_item_contact, parent, false);
        //Return View
        return new ViewHolder(view, onContactListener);
    }

    @Override
    public void onBindViewHolder(@NonNull DmMainAdapter.ViewHolder holder, int position) {
